  ...
  locations: {
    ...
    Home: {
      ...
      conversation: [
        ...
        {
          text: 'This is your room. Feel free to use the rajio and teeburu. Raito is here.',
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_neutral.png',
        },
        ...
        {
          text: "Just watch for our petto, don't let her on the beddo.",
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_happy.png',
        },
    ...
    'Shopping centre': {
      ...
      conversation: [
        ...
        {
          text: 'Hmm… what shall we have? Hambaagaa? Sooseji?',
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_excited.png',
        },
        {
          text: 'hambaagaa ハンバーガー sooseji ソーセージ',
          type: 'quiz',
          options: [
        ...
        {
          text: 'Fraido potato フライドポテト sarada サラダ sandoicchi サンドイッチ',
          type: 'quiz',
          options: [
        ...
        {
          text: "And for a dessert, let's go to Starbucks! Let's have aisu koohii!",
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_happy.png',
        },
        {
          text: 'aisu koohii アイスコーヒー',
          type: 'quiz',
          options: [
        ...
        {
          text: 'Oh, look, they have a matcha kitto katto!',
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_excited.png',
        },
        ...
        {
          text: "Let's also get my parents some keeki when they come back. And for us, we can buy some aisukuriimu.",
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_neutral.png',
        },
        {
          text: 'keeki ケーキ aisukuriimu アイスクリーム',
          type: 'quiz',
          options: [
        ...
        {
          text: 'Grrr, saabisu is really lacking today.',
          type: 'dialogue',
          character: 'Hanako',
        ...
        {
          text: "Oh, we forget to buy some biiru for my parents, let's go to the konbini near my house.",
          type: 'dialogue',
          character: 'Hanako',
        ...
        {
          text: "Damn, they won't sell arukooru to the minors.",
          type: 'dialogue',
          character: 'Hanako',
          mood: 'hanako_sad.png',
        },
        ...
        {
          text: "I can't believe I survived today. I didn't even kill myself at the esukareetaa how they call it.",
          type: 'dialogue',
          character: 'Charlie',
          mood: 'charlie_happy.png',
        },
        {
          text: 'esukareetaa エスカレーター',
          type: 'quiz',
          options: [
